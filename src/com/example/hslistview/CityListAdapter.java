...
public class CityListAdapter extends LZBaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			loHolder.moTvCityName = (TextView) convertView.findViewById(R.id.item_city_list_tv_name);
			loHolder.moLlCityName = (LinearLayout) convertView.findViewById(R.id.item_city_list_ll_name);
		...
		if (selectedPos == position) {
			loHolder.moLlCityName.setBackgroundColor(Color.parseColor("#EDC53B"));
			loHolder.moTvCityName.setTextColor(Color.parseColor("#FFFFFF"));
		} else {
			loHolder.moLlCityName.setBackgroundColor(Color.parseColor("#FFFFFF"));
